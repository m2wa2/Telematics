...
const authOptions = {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            credentials: {
                email: {
                    label: "Email",
                    type: "email",
                    placeholder: "admin@matrixtelematic.co.ke"
                },
                password: {
                    label: "Password",
                    type: "password"
            ...
            async authorize (credentials) {
                ...
                if (credentials.email === 'admin@matrixtelematic.co.ke' && credentials.password === 'adminpassword123') {
                    return {
                        id: 'admin-1',
                        name: 'Super Admin',
    ...
    secret: process.env.NEXTAUTH_SECRET || "hub31-matrix-super-secret"
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lfi-lb._.js.map